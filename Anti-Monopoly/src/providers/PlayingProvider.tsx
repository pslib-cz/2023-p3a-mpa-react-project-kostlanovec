...
import { Field, PlayingPlayer, Player, GameState  } from '../types/type';
  ...
  const playingReducer = (state: GameState, action: Action): GameState => {
    switch (action.type) {
      ...
      case "PAY_TAX":
        ...
        // ještě je tam pár logických chyb, jelikož jsem se rozhodl to z polí indexu změnit na id, tím se to celý změnilo a určitě i někde jinde budou podobné chyby.
        case 'BUY_PROPERTY':
        ...
        case 'BUY_HOUSE': {
          ...
          if (fieldIndex !== -1 && playerIndex !== -1) {
            ...
            const housePrice = field.type === "PROPERTY" ? city.find(city => city.id === field.cityid)?.pricehouse : undefined;
